// Generated by gencpp from file disco_double/context_info.msg
// DO NOT EDIT!


#ifndef disco_double_MESSAGE_CONTEXT_INFO_H
#define disco_double_MESSAGE_CONTEXT_INFO_H
...
struct context_info_
{
  ...
  typedef boost::shared_ptr< ::disco_double::context_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::disco_double::context_info_<ContainerAllocator> const> ConstPtr;

}; // struct context_info_

typedef ::disco_double::context_info_<std::allocator<void> > context_info;

typedef boost::shared_ptr< ::disco_double::context_info > context_infoPtr;
typedef boost::shared_ptr< ::disco_double::context_info const> context_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::disco_double::context_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::disco_double::context_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::disco_double::context_info_<ContainerAllocator1> & lhs, const ::disco_double::context_info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::disco_double::context_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::disco_double::context_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::disco_double::context_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::disco_double::context_info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::disco_double::context_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::disco_double::context_info_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::disco_double::context_info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::disco_double::context_info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9a9c154ef0140913ULL;
  static const uint64_t static_value2 = 0x38773daa36dd5bd3ULL;
};

template<class ContainerAllocator>
struct DataType< ::disco_double::context_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "disco_double/context_info";
  }
...
template<class ContainerAllocator>
struct Definition< ::disco_double::context_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Robot Name\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::disco_double::context_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::disco_double::context_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::disco_double::context_info_<ContainerAllocator>& v)
  {
    s << indent << "robotID: ";
...
#endif // disco_double_MESSAGE_CONTEXT_INFO_H
